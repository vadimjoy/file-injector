...
2. Copy files from `docs/en/` as a starting point
3. Translate all content
4. Add a language switcher header to each file: `> **Language:** [English](../en/filename.md) | [Русский](../ru/filename.md) | **NewLang**`
