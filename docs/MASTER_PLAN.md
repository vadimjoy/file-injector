...
- [x] `docs/adr/` содержит минимум 3 ADR (0001–0003) *(0001 Atomic Decoupling, 0002 Context Modifier, 0003 AI Token Naming)*
- [x] Все компоненты имеют `--ai-[component]-*` токены *(все 15 компонентов обновлены)*
- [x] `--ui-*` токены сохранены как алиасы (breaking changes = 0) *(`--ai-*` ссылаются на `--ui-*` по умолчанию)*
- [x] Документ `docs/adr/README.md` с индексом решений *(индекс обновлён)*
...
- [x] `scripts/theme-map.js` работает и покрыт тестами *(28 unit-тестов, Node built-in test runner, 2026-04-07)*
- [x] Поддержаны форматы W3C Design Tokens и Figma Tokens *(detectFormat + flattenTokens, 2026-04-07)*
- [x] Минимум 3 встроенных пресета темы (default, dark, corporate) *(5 пресетов: default, dark, midnight, corporate, warm, 2026-04-07)*
- [x] `@layer` внедрён для всех компонентных стилей *(ai-kit.tokens, ai-kit.base, ai-kit.components, ai-kit.themes, 2026-04-07)*
- [x] Документация с примерами в `docs/theming.md` *(Token Reference, CLI examples, @layer explanation, 2026-04-07)*
