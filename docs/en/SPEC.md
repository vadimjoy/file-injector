...
> **Language / Язык:** English (full spec) | [Русский (краткая версия)](../ru/SPEC.md)  
> **Multilingual docs index:** [docs/README.md](../README.md)
...
Полный формат описан в [`docs/theming.md`](../theming.md).
