...
CLI генерирует HTML-разметку из описания на естественном языке. Превращает запросы вида `"кнопка основного действия"` в готовый к продакшену HTML с классами ai-css-kit.
