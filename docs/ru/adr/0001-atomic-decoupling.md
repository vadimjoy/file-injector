...
> **Язык:** Русский | [English](../../en/adr/0001-atomic-decoupling.md)
...
- [x] Реализовать новые модификаторы `.ui-input--icon-*` в `input.css`
- [x] Удалить coupling-правила из `datepicker.css` и `autocomplete.css`
- [x] Написать `scripts/audit-coupling.js`
- [x] Добавить audit-скрипт в CI (`package.json scripts.lint:coupling`)
- [x] Обновить `SPEC.md` — HTML-контракты datepicker и autocomplete
- [x] Обновить `src/demos/datepicker.html` и `src/demos/autocomplete.html`
